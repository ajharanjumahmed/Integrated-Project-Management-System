        ...
        <div class="flex flex-col gap-6">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <Link href="/users/create"
                    class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 w-fit md:text-sm text-xs">
                    Create User
                </Link>
            ...
            <div class="bg-white rounded-xl overflow-hidden shadow-sm">
                ...
                <table class="w-full text-sm">
                    ...
                    <thead class="bg-blue-600 text-left text-white uppercase">
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr v-for="user in users.data" :key="user.id" class="border-t border-gray-200">
                            ...
                            <td class="pl-5 font-medium text-gray-700">{{ user.name }}</td>
                            ...
                            <td class="pl-5 pt-4 pb-4 flex gap-3 ">
                                ...
                                <button @click="openDelete(user)" class="px-8 py-2 bg-red-500 text-white rounded">
                                    Delete
                                </button>
            ...
            <div class="grid gap-4 md:hidden">
                ...
                <div v-for="user in users.data" :key="user.id" class="bg-white p-4 rounded shadow flex flex-col gap-2">
                    ...
                    <div class="flex gap-4 mt-2">
                        ...
                        <Link :href="`/users/${user.id}/edit`" class="text-blue-600">
                            Edit
                        </Link>
            ...
            <div v-if="deleteUser" class="fixed inset-0 flex items-center justify-center bg-black/40">

                <div class="bg-white rounded-xl p-6 w-full max-w-md">

                    <h2 class="text-xl font-semibold mb-2 text-gray-900 pb-2">
                        Delete User
                    </h2>
                    ...
                    <div class="flex justify-end gap-3">
                        ...
                        <button @click="closeDelete" class="px-4 py-2 border border-gray-500 rounded-lg text-gray-700">
                            Cancel
                        </button>
